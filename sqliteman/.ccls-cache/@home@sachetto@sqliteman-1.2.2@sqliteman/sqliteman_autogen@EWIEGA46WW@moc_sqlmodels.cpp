/****************************************************************************
** Meta object code from reading C++ file 'sqlmodels.h'
**
...
#include <memory>
#include "sqliteman/sqlmodels.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'sqlmodels.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 13), // "doPrimeInsert"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11) // "QSqlRecord&"

    },
    "SqlTableModel\0doPrimeInsert\0\0QSqlRecord&"
};
...
void SqlTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SqlTableModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doPrimeInsert((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QSqlRecord(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject SqlTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_SqlTableModel.data,
    qt_meta_data_SqlTableModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
